...
const ElectricConductanceConverter = () => {
    const [inputValue, setInputValue] = useState('');
    const [fromUnit, setFromUnit] = useState('Siemens');
    const [toUnit, setToUnit] = useState('Siemens');
    ...
    return (
        <div className="conversion" id="electric-conductance">
            ...
            <div className='percentage-button green-button' onClick={convertConductance}>
                Calculate
            </div>
...
export default ElectricConductanceConverter;
